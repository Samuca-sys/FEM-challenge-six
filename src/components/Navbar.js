...
const Navbar = () => {
	return(
		<nav className="navbar">
			<h2 className="navbar__header">Where in the world?</h2>
			<svg className="navbar__icon" width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<h4 className="navbar__button">Dark mode</h4>
		</nav>
	)
}
